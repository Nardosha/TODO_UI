...
})({"fXZRt":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
var _viewJs = require("./modules/view.js");
var _variablesJs = require("./modules/variables.js");
// Add task
_variablesJs.UI.INPUT_FIELD.forEach((currentInputField)=>currentInputField.onchange = function(e1) {
        e1.preventDefault();
        let inputValue = e1.target.value.trim();
        if (!inputValue) return;
        console.log(inputValue, currentInputField.id, e1.target);
        ...
        currentInputField.closest('.task__input').onclick = function(e) {
            ...
            if (e.target === addTaskBtn) {
                _viewJs.addTask(inputValue, currentBlock);
                inputValue = '';
            }
        };
...
_variablesJs.UI.TASK_LIST.forEach((currentTaskList)=>currentTaskList.addEventListener('click', function(e) {
        if (e.target.classList.contains('item__button-done')) e.target.closest('.task__item').classList.add('_done');
        if (e.target.classList.contains('item__button-cancel')) e.target.closest('.task__item').remove();
    })
);
// Get task from input
function getInputValue(e) {
    if (e.target.value) return e.target.value.trim();
}

},{"./modules/view.js":"8p2JQ","./modules/variables.js":"9uxdY"}],"8p2JQ":[function(require,module,exports) {
...
function getDate() {
    let date = _dateFns.format(new Date(), 'dd.MM');
    console.log(date);
    return date;
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9uxdY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fXZRt","10Fj0"], "10Fj0", "parcelRequire96d8")
